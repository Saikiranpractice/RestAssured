...
public class EmployeeTest2 {
	...
	public void postEmployee()
	{
		...
		Response res= UserEndPoints2.createEmployee(payload);
		res.then().log().body();
	...
	public void getEmployee()
	{
		...
		Response res= UserEndPoints2.getEmployee(this.payload.getId());
		res.then().log().body();
	...
	public void putEmployee()
	{
		...
		Response res= UserEndPoints2.updateEmployee(this.payload.getId(),payload);
		res.then().log().body();
	...
	public void deleteEmployee()
	{
		...
		Response res= UserEndPoints2.deleteEmployee(this.payload.getId());
		res.then().log().all();
